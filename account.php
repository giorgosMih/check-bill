...
$id = $_SESSION['uid'];
$sql = '
SELECT u.username, ac.last_name, ac.first_name 
...
<body>
    ...
    <div class="container-fluid">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#">Λογαριασμός</a>
        ...
        <div class="row m-0 p-0">
            <div class="col-12 buttons">
                ...
                <button type="button" onclick="showdeleteUserModal(event, <?php echo $_SESSION['uid'];?>)" class="btn btn-outline-danger" title="Διαγραφή Λογαριασμού">
    ...
    ?>
        ...
        <div class="row m-0 p-0">
            <div class="col-12">
                <h4>Επεξεργασία του Λογαριασμού μου</h4>
                <br />
